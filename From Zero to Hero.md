...
我知道 AI 可以在 DevOps 方面对我有很大帮助。我之前已经测试过了，当时我让 Clio 使用 Hugo 为我构建了一个静态博客，并将其部署到 Amazon Web Service 上的实时服务器。我们甚至一起坐下来进行自动化部署。我学到了一些东西，但如果我在没有 AI 指导的情况下尝试这样做，我仍然会迷失方向。

    What is Clio? Learn more about Clio, our AI copilot that runs in your CLI, here.
    什么是 Clio？在此处了解有关 Clio 的更多信息，Clio 是我们在 CLI 中运行的 AI 副驾驶。
...
如果你想自己尝试一下，你可以去 https://github.com/gptscript-ai/clio。在这里，您会找到安装指南和类似指南。
